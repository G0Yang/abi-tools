  ...
  const columns: GridColDef[] = [
    ...
    },
    {
      ...
      renderCell: params => {
        ...
        return bytecode.length > 10
          ? `${bytecode.substring(0, 10)}... (${sizeInBytes} bytes)`
          : `${bytecode} (${sizeInBytes} bytes)`
      }
    },
    {
          ...
          <Table>
            <TableBody>
              ...
              <TableRow>
                ...
                <TableCell>
                  <Typography sx={{ wordBreak: 'break-all' }}>{modalData.bytecode}</Typography>
                </TableCell>
              </TableRow>
              <TableRow>
                <TableCell align='right'>DeployedBytecode</TableCell>
                <TableCell>
                  <Typography sx={{ wordBreak: 'break-all' }}>{modalData.deployedBytecode}</Typography>
                </TableCell>
              </TableRow>
            </TableBody>
          </Table>
